...
local mykeyboardlayout = wibox.container.margin(keyboard, 8, 8, 0, 0)
...
local mywifibar = require("widgets/wifi")
...
local systray_margin = wibox.container.margin(mysystray, 0, 10, 6, 6)
...
awful.screen.connect_for_each_screen(function(s)
	...
	local layouts = { l.fair, l.tile.bottom, l.fair, l.fair, l.fair, l.fair, l.fair, l.fair, l.fair }
...
globalkeys = gears.table.join(
	...
	end, { description = "focus window on the left", group = "client" }),
	...
	end, { description = "focus window on the right", group = "client" }),
	...
	end, { description = "take an area screenshot", group = "launcher" }),
	...
	awful.key({ modkey }, "space", function()
		awful.spawn.with_line_callback("setxkbmap -query", {
			stdout = function(line)
				if string.find(line, "layout") then
					if string.find(line, "us") then
	...
	end, { description = "toggle keyboard layout", group = "layout" }),
